#include "VPFRootListController.h"

@implementation VPFRootListController
	...
	-(void) sendEmail{
		[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"mailto:merlino.giuseppe1@gmail.com?subject=VideoPaneFix"]];
	}
